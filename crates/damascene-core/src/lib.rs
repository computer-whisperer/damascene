...
pub use plot::{
    AxisView, Curve, Decimation, LegendPosition, LineMark, Mark, PlotControls, PlotRequest,
    PlotSpec, PlotStyle, PlotView, Sample, Scale, ScatterMark, SeriesBounds, SeriesHandle, Tick,
};
pub use scene::{
