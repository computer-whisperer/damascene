...
`crates/aetna-core/src/paint/shaders/` (`rounded_rect.wgsl`,
`text_sdf.wgsl`, `focus_ring.wgsl`) and the cross-tree exemplars
(`crates/aetna-fixtures/.../liquid_glass.wgsl`,
...
- Default working space: `aetna_core::paint::DEFAULT_WORKING_COLOR_SPACE`
...
Aetna's `Color` type carries a `ColorSpace` tag end-to-end. The paint
